...
\begin{center}
    ...
    \hline
    ID & Description & Inputs & Outputs \\ \hline
    \#7 & Add Item page & \pbox{3cm}{Item name,date,brand} & \pbox{3cm}{Item Information}  \\ \hline
    \#8 & Add Item page & \pbox{3cm}{N/A} & \pbox{3cm}{msg from the controller}  \\ \hline
    \end{tabular}
\end{center}
\end{table}
...
\begin{center}
    ...
    \hline
    ID & Description & Inputs & Outputs \\ \hline
    \#9 & Search page & \pbox{3cm}{barcode or text} & \pbox{3cm}{item information}  \\ \hline
    \#10 & Search page & \pbox{3cm}{N/A} & \pbox{3cm}{msg from the UI Controller}  \\ \hline
    \end{tabular}
\end{center}
\end{table}
