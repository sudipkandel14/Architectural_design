...
\begin{center}
    ...
    \hline
    ID & Description & Inputs & Outputs \\ \hline
    \#3 & User Register Page & \pbox{3cm}{Username,Password,Email,DOB} & \pbox{3cm}{user information}  \\ \hline
    \#4 & User Register Page & \pbox{3cm}{N/A} & \pbox{3cm}{msg from the controller}  \\ \hline
    \end{tabular}
\end{center}
\end{table}
...
\begin{center}
    ...
    \hline
    ID & Description & Inputs & Outputs \\ \hline
    \#5 & Add shelf page & \pbox{3cm}{Shelf dimensions} & \pbox{3cm}{Shelf information}  \\ \hline
    \#6 & Add shelf page & \pbox{3cm}{N/A} & \pbox{3cm}{msg from the UI controller}  \\ \hline
    \end{tabular}
\end{center}
\end{table}
...
\begin{center}
    ...
    \hline
    ID & Description & Inputs & Outputs \\ \hline
    \#7 & Add Item/ UI Controller & \pbox{3cm}{name,Expiration \\ brand,\\ Quantity,Price} & \pbox{3cm}{N/A}  \\ \hline
    \#8 & Add Item page & \pbox{3cm}{N/A} & \pbox{3cm}{Item add successfull \\ Item add fail}  \\ \hline
    \end{tabular}
\end{center}
\end{table}
...
\begin{center}
    ...
    \hline
    ID & Description & Inputs & Outputs \\ \hline
    \#9 & Search/ UI Controller & \pbox{3cm}{barcode or text} & \pbox{3cm}{N/A}  \\ \hline
    \#10 & UI Controller/ Search page & \pbox{3cm}{N/A} & \pbox{3cm}{Item Information}  \\ \hline
    \end{tabular}
\end{center}
\end{table}
